...
public class AdFactory {
    ...
    public static Advertisement createAd(Date datePublished, String uniqueOwnerID, String uniqueAdID, String title, List<String> imgURLs, String description, long price, Advert.Condition condition) {
