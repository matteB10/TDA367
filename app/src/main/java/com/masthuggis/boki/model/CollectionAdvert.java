...
public class CollectionAdvert {
     ...
     * @param userId          Id of User which is selling the collection.
     ...
     */
    public CollectionAdvert(List<Advert> adverts, int userId, String collectionName, int collectionPrice, String datePublished) {
